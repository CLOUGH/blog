...
@section('content')
	...
	<div class="wrapper wrapper-content animated fadeIn">
		<form method="POST" action="{{ url("admin/portfolios/$portfolio->id") }}">
			{!! csrf_field() !!}
						...
						<div class="ibox-content">
							<div>
								<label class="font-noraml checkbox" style="padding-left: 0px">
									...
									<input type="checkbox" class="i-checks" name="published" value="{{ old('published') ? old('published') : $portfolio->published }}">
								</label>
							</div>
							<div class="form-group">
								<label class="font-noraml">Publish At</label>
								<input type="date" class="form-control" name="publish_at" value="{{ old('publish_at') ? old('publish_at') : $portfolio->publish_at }}">
							</div>
							<div class="form-group">
					...
					<div class="ibox">
						...
						<div class="ibox-content">
							<div class="form-group">
								...
								<input type="text" name="name" class="form-control" value="{{ old('name') ?  old('name') :	 $portfolio->name }}">
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="form-control" name="categories[]" multiple="multiple" id="categories" style="width: 100%">
											@foreach(( old('categories') ? $old('categories') : $portfolio->categories ) as $category)
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="form-control" name="tags[]" multiple="multiple" id="tags" style="width: 100%">
											@foreach(( old('tags') ? $old('tags') : $portfolio->tags ) as $tag)
							...
							<div class="form-group">
								...
								<input type="file" name="pictures[]" accept="image/*" multiple  value="{{ old('pictures') ? old('pictures') : $portfolio->pictures }}">
							</div>
							<div class="form-group">
								<label class="font-noraml">Description</label>
								<textarea class="form-control summernote" name="description">{{  $portfolio->description or old('description') }}</textarea>
							</div>
						</div>
					</div>
				</div>
